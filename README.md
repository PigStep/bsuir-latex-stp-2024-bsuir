...
- Если вы работаете с LLM - изучите `GeneratingPrompt.md`. Этот файл содержит инструкцию для работы с моим шаблоном (так же может быть изучен для понимая команд)
- Изучите [Структура проекта](#-структура-проекта) для получения дополнительной информации о шаблоне
