...
\input{marker}                         % Маркер 60% для контроля ГОСТ
...
\includepdf[pages=-, pagecommand={}, fitpaper, offset=0 0]{TitlePage.pdf} % Вставляем страницы Титульного листа (PDF)
...
\clearpage
\thispagestyle{empty}
\includepdf[pages=-, pagecommand={}, fitpaper, offset=0 0]{TZ.pdf} % Вставляем страницы ТЗ (PDF)
...
% ОГЛАВЛЕНИЕ
% -----------------------------------------------------------------------------
\renewcommand{\contentsname}{СОДЕРЖАНИЕ}            % Иногда LaTeX пишет CONTENTS
